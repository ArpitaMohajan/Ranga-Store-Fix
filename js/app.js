...
const showProducts = (data) => {
    const allProducts = data.map((pd) => pd);
    ...
    <img class="product-image" src=${image}></img>
      ...
      <button id="details-btn" onclick='totalDetails(${product.price},${rate})' class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal">Details</button></div>
      `;
        document.getElementById("all-products").appendChild(div);
    }
};

const totalDetails = (price, rating) => {
